...
const App = () => {
  ...
  const fetchStats = async () => {
    try {
      const res = await fetch(`${REST_API_URL}/admin/stats`)
      if (res.ok) {
  ...
  const fetchReports = async () => {
    try {
      const res = await fetch(`${REST_API_URL}/admin/reports?limit=10`)
  ...
  const fetchTransactions = async () => {
    try {
      const res = await fetch(`${REST_API_URL}/admin/transactions?limit=15`)
                                ...
                                <button
                                  onClick={async () => {
                                    if (confirm('Are you sure you want to ban this user?')) {
                                      await fetch(`${REST_API_URL}/admin/ban`, {
                                        method: 'POST',
